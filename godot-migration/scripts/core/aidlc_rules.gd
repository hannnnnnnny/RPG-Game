## AIDLC 状态变更审批 —— 等价于 src/core/aidlcRules.ts
##
## 用法：注册为 Autoload "AidlcRules"
## GameState.request_state_change 内部会调 AidlcRules.approve_state_change
...
## 返回 { "approved": bool, "reason": String }
